...
public class ECColorRadio extends RadioButton implements ValueAnimator.AnimatorUpdateListener {

    private static final String TAG = "ECColorRadio";
    ...
    public ECColorRadio(Context context) {
        this(context, null, 0);
    }

    public ECColorRadio(Context context, AttributeSet attrs) {
        super(context, attrs);
        initialize(context, attrs, 0);
    }

    public ECColorRadio(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        initialize(context, attrs, defStyleAttr);
    }

    private void initialize(Context context, AttributeSet attrs, int defStyleAttr) {
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.ECColorRadio);

        mColor = a.getColor(R.styleable.ECColorRadio_image_color, Color.WHITE);
        mStrokeColor = a.getColor(R.styleable.ECColorRadio_image_stroke_color, Color.WHITE);
