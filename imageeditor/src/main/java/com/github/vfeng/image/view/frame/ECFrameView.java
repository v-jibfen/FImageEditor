...
import com.github.vfeng.image.frame.ECFrameAdjustHelper;
import com.github.vfeng.image.frame.ECFrameHelper;
import com.github.vfeng.image.frame.ECFrameMoveHelper;
import com.github.vfeng.image.utils.LogUtils;
import com.github.vfeng.image.utils.SizeUtils;

/**
 * Created by vfeng on 2020/8/18.
 * 磁力片base view
 */
public abstract class ECFrameView extends ViewGroup implements IECFrame, View.OnClickListener {
    ...
    private static final int ANCHOR_SIZE = SizeUtils.INSTANCE.dp2px(24);
    ...
    public ECFrameView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ECFrameView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void onInitialize(Context context) {
        ...
        new ECFrameAdjustHelper(this, mAdjustView);

        mFrameHelper = new ECFrameHelper<>(this);
        mMoveHelper = new ECFrameMoveHelper(this);
    }
    ...
    public void setScale(float scale) {
        LogUtils.INSTANCE.d(TAG, "setScale : " + scale);
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        mRemoveView.layout(0, 0, ANCHOR_SIZE, ANCHOR_SIZE);
        mAdjustView.layout(
    ...
    @Override
    public boolean show() {
        return mFrameHelper.show();
    }

    @Override
    public boolean remove() {
        return mFrameHelper.remove();
    }

    @Override
    public boolean dismiss() {
        return mFrameHelper.dismiss();
    }

    @Override
    public boolean isShowing() {
        return mFrameHelper.isShowing();
    }

    @Override
    public RectF getFrame() {
        return mFrameHelper.getFrame();
    }
    ...
    public void registerCallback(Callback callback) {
        mFrameHelper.registerCallback(callback);
    }

    @Override
    public void unregisterCallback(Callback callback) {
        mFrameHelper.unregisterCallback(callback);
    }
}
