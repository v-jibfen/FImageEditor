package com.github.vfeng.image.view.clip;
...
public class IMGClipWindow implements IMGClip {
    ...
    public void setClipWinSize(float width, float height) {
        ...
        if (!mFrame.isEmpty()) {
            ImageUtils.INSTANCE.center(mWinFrame, mFrame);
    ...
    private void reset(float clipWidth, float clipHeight) {
        ...
        ImageUtils.INSTANCE.fitCenter(mWinFrame, mFrame, CLIP_MARGIN);
        mTargetFrame.set(mFrame);
    }
    ...
    public boolean recovering() {
        ...
        mTargetFrame.set(mFrame);
        ImageUtils.INSTANCE.fitCenter(mWinFrame, mTargetFrame, CLIP_MARGIN);
        return isRecovering = !mTargetFrame.equals(mBaseFrame);
    }

    public void recovering(float fraction) {
        if (isRecovering) {
            mFrame.set(
